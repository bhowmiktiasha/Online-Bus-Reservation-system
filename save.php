...
while($row = mysql_fetch_array($result))
	...
	$payable=$qty*$price;
mysqli_query("INSERT INTO customer (fname, lname, address, contact, bus, transactionum, payable, setnumber)
VALUES ('$fname', '$lname', '$address', '$contact', '$busnum', '$confirmation','$payable','$setnum')");
mysqli_query("INSERT INTO reserve (date, bus, seat_reserve, transactionnum, seat)
